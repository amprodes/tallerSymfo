!function ($) {
    ...
    Pages.prototype.setUserOS = function () {
        ...
        var elem = $(".pg-colors").length ? $(".pg-colors") : $('<div class="pg-colors"></div>').appendTo("body"), colorElem = elem.find('[data-color="' + color + '"]').length ? elem.find('[data-color="' + color + '"]') : $('<div class="bg-' + color + '" data-color="' + color + '"></div>').appendTo(elem), color = colorElem.css("background-color"), rgb = color.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/), rgba = "rgba(" + rgb[1] + ", " + rgb[2] + ", " + rgb[3] + ", " + opacity + ")";
        return rgba
        ...
        $(".dropdown-default").each(function () {
            var btn = $(this).find(".dropdown-menu").siblings(".dropdown-toggle"), offset = 0, menuWidth = (btn.actual("innerWidth") - btn.actual("width"), $(this).find(".dropdown-menu").actual("outerWidth"));
        ...
        $.fn.scrollbar && $(".scrollable").scrollbar({ignoreOverlay: !1})
    }, Pages.prototype.initListView = function () {
        $.fn.ioslist && $('[data-init-list-view="ioslist"]').ioslist(), $.fn.scrollbar && $(".list-view-wrapper").scrollbar({ignoreOverlay: !1})
    ...
    SelectFx.prototype.options = {
        ...
        this.hasDefaultPlaceholder = selectedOpt && selectedOpt.disabled, this.selectedOpt = selectedOpt || this.el.querySelector("option"), this._createSelectEl(), this.selOpts = [].slice.call(this.selEl.querySelectorAll("li[data-option]")), this.selOptsCount = this.selOpts.length, this.current = this.selOpts.indexOf(this.selEl.querySelector("li.cs-selected")) || -1, this.selPlaceholder = this.selEl.querySelector("span.cs-placeholder"), this._initEvents(), this.el.onchange = function () {
            var index = this.selectedIndex, inputText = this.children[index].innerHTML.trim();
        ...
        if (this._isOpen()) {
            ...
            var contentHeight = csOptions.offsetHeight, originalHeight = csPlaceholder.offsetHeight, scaleV = (csOptions.offsetWidth, csPlaceholder.offsetWidth, contentHeight / originalHeight);
    ...
    function Plugin(option) {
        return this.filter(":input").each(function () {
            var $this = $(this), data = $this.data("pg.circularProgress"), options = "object" == typeof option && option;
    ...
    Parallax.VERSION = "1.0.0", Parallax.prototype.animate = function () {
        var scrollPos, pagecoverWidth = this.$element.height(), opacityKeyFrame = 50 * pagecoverWidth / 100, direction = "translateX";
        scrollPos = $(window).scrollTop(), direction = "translateY", this.$coverPhoto.css({transform: direction + "(" + scrollPos * this.options.speed.coverPhoto + "px)"}), this.$content.css({transform: direction + "(" + scrollPos * this.options.speed.content + "px)"}), this.$content.css(scrollPos > opacityKeyFrame ? {opacity: 1 - scrollPos / 1200} : {opacity: 1})
    };
    var old = $.fn.parallax;
    ...
    var Sidebar = function (element, options) {
        function sidebarMouseEnter(e) {
            return $.Pages.isVisibleSm() || $.Pages.isVisibleXs() ? !1 : void($(".close-sidebar").data("clicked") || _this.$body.hasClass("menu-pin") || (_this.cssAnimation ? (_this.$element.css({transform: _this.menuOpenCSS}), _this.$body.addClass("sidebar-visible")) : _this.$element.stop().animate({left: "0px"}, 400, $.bez(_this.bezierEasing), function () {
        ...
        if (this.$element = $(element), this.options = $.extend(!0, {}, $.fn.sidebar.defaults, options), this.bezierEasing = [.05, .74, .27, .99], this.cssAnimation = !0, this.menuClosedCSS, this.menuOpenCSS, this.css3d = !0, this.sideBarWidth = 280, this.sideBarWidthCondensed = 210, this.$sidebarMenu = this.$element.find(".sidebar-menu > ul"), this.$pageContainer = $(this.options.pageContainer), this.$body = $("body"), this.$sidebarMenu.length) {
            "desktop" == $.Pages.getUserAgent() && this.$sidebarMenu.scrollbar({ignoreOverlay: !1}), Modernizr.csstransitions || (this.cssAnimation = !1), Modernizr.csstransforms3d || (this.css3d = !1), this.menuOpenCSS = 1 == this.css3d ? "translate3d(" + this.sideBarWidthCondensed + "px, 0,0)" : "translate(" + this.sideBarWidthCondensed + "px, 0)", this.menuClosedCSS = 1 == this.css3d ? "translate3d(0, 0,0)" : "translate(0, 0)", $("body").on("click", ".sidebar-menu a", function (e) {
